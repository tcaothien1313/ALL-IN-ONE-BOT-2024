...
shipUser1Description: 'user 1',
shipUser2Description: 'user 2',
shipEmbedTitle: 'Love Rate',
...
shipMentionErrorMessage: 'Vui lòng gắn thẻ hai người dùng',
//wordassoc.js
...
addRoleAlreadyHasRole: '${target.tag} đã có vai trò ${role.name} rồi.',
...
muteCannotMute: 'Không thể mute ${target.tag}!',
muteSuccess: '${target.tag} has been muted for ${duration} minutes.',
muteOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua slash!\n-  Vui lòng sử dụng `/mute` để mute thành viên.',
muteAlert: 'Alert!',
// purge.js
purgeCommandDescription: 'Xóa tin nhắn được chỉ định khỏi kênh',
...
purgeNoDeletePermission: 'Không có quyền xóa tin nhắn.',
...
// setnickname.js
setnicknameCommandDescription: 'Set biệt danh cho member',
setnicknameNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
setnicknameSuccess: '{target} đã được đổi thành {nickname}.',
...
setnicknameFailed: 'Không đặt được biệt danh. Vui lòng thử lại sau.',
setnicknamePrefixError: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/setnickname` để thay đổi biệt danh của thành viên.',
// setslowmode.js
setslowmodeCommandDescription: 'Đặt chế độ chậm cho kênh',
setslowmodeNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
setslowmodeInvalidDuration: 'Vui lòng nhập khoảng thời gian từ 0 đến 21600 giây.',
setslowmodeSuccess: 'Đặt chế độ chậm thành {duration} giây.',
setslowmodePrefixError: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/setslowmode` để set slow mode.',
// timeout.js
...
// unmute.js
unmuteDescription: 'Unmutes một thành viên trong máy chủ',
...
warnDMTitle: 'Bạn đã được cảnh báo!',
warnDMDescription: 'Bạn đã nhận được cảnh báo từ {sender} trong {guildName} vì: {reason}',
// createembed.js
...
// giveaway.js
giveawayDescription: 'Tạo giveaways',
...
// status.js
statusDescription: 'Kiểm tra trạng thái thành viên trên máy chủ',
statusTitle: '{username}\'s Status',
statusLabel: '**Status:** {status}',
activitiesLabel: '**Activities:**\n{activities}',
noActivities: 'None',
errorFetchingStatus: 'Không thể tìm nạp trạng thái của người dùng.',
// timer.js
